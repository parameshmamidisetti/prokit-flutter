...
ProTheme getFullApps() {
  ...
  list.add(ProTheme(name: 'Carea', tag: 'New', widget: CareaSplashScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Room Finder', tag: 'New', widget: RFSplashScreen(), darkThemeSupported: true));
